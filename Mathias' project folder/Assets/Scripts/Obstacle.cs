...
public class Obstacle : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		transform.Translate(new Vector3 (0, obstacleSize/2, 0));
		changeColor ();
		
		void Start () {
			
			transform.localScale = new Vector3 (1f,obstacleSize,1f); //Sets the height of the obstacle to be equal to obstacle size
		...
		void Update () 
		{
			...
			transform.Translate(new Vector3 (-4,0,0) * Time.deltaTime); // Moves the obstacle 4 units to left every second
